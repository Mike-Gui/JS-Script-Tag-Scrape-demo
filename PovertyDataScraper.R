...
#poverty and population data collected here. This part can take up 20 minutes to run through
...
#Combining county names, FIPS codes, population and poverty data
...
df <- data.frame(regions, df)#converts all relevant info to single data frame
